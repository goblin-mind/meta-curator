...
const SelectTagsDialog = ({ isOpen, onClose, onApplyTags }: ApplyTagsProps) => {
    ...
    const loadTags = async (inputValue: string) => {
        ...
        const response = await fetch('http://localhost:3000/tags').then((response) => response.json())
        //await ipcRenderer.invoke('list-tags', inputValue)
        setTagOptions(
